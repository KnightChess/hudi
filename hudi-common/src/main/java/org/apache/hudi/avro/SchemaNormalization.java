...
/**
 * copy from org.apache.avro.SchemaNormalization
...
public class SchemaNormalization {
  ...
  public static long fingerprint64(byte[] data) {
    long result = EMPTY64;
    for (byte b : data) {
      result = (result >>> 8) ^ SchemaNormalization.FP64.FP_TABLE[(int) (result ^ b) & 0xff];
    }
    return result;
  }
  ...
  static final long EMPTY64 = 0xc15d213aa4d7a795L;
